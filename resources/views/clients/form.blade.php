...
<div class="form-group {{ $errors->has('company') ? ' has-error' : '' }}">
	...
	<input id="company" type="company" class="form-control" name="company" placeholder="Acme Corporation" value="{{ $client->company or old('company') }}" autofocus>
...
<div class="row">
	...
	<div class="form-group{{ $errors->has('first_name') ? ' has-error' : '' }} col-md-6">
		...
		<input id="first_name" type="first_name" class="form-control" name="first_name" placeholder="First Name" value="{{ $client->first_name or old('first_name') }}"  autofocus>
	...
	<div class="form-group{{ $errors->has('last_name') ? ' has-error' : '' }} col-md-6">
		...
		<input id="last_name" type="last_name" class="form-control" name="last_name" placeholder="Last Name" value="{{ $client->last_name or old('last_name') }}"  autofocus>
...
<div class="row">
	<div class="form-group{{ $errors->has('email') ? ' has-error' : '' }} col-md-6">
		...
		<input id="email" type="email" class="form-control" name="email" placeholder="Email" value="{{ $client->email or old('email') }}"  autofocus>
		@if ($errors->has('email'))
		<span class="help-block">
			<ul class="no-indent">
	...
	<div class="form-group{{ $errors->has('phone_number') ? ' has-error' : '' }} col-md-6">
		...
		<input id="phone_number" type="phone_number" class="form-control" name="phone_number" placeholder="1234567890" value="{{ $client->phone_number or old('phone_number') }}"  autofocus>
...
<div class="row">
	...
	<div class="form-group {{ $errors->has('address') ? ' has-error' : '' }} col-md-12">
		...
		<input id="address" type="address" class="form-control" name="address" placeholder="24 Acme Rd NY, NY 10001" value="{{ $client->address or old('address') }}"  autofocus>
...
<div class="row">
	...
	<div class="form-group {{ $errors->has('client_notes') ? ' has-error' : '' }} col-md-12">
		...
		<textarea id="client_notes" type="client_notes" class="form-control" name="client_notes" placeholder="Enter a note for this client" autofocus>{{ $client->client_notes or old('client_notes') }}</textarea>
